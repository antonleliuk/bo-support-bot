...
class HelpDialog extends botbuilder_dialogs_1.ComponentDialog {
    constructor(dialogId, qnaConfig) {
        super(dialogId);
        this.askQuestionForHelp = (step) => __awaiter(this, void 0, void 0, function* () {
            return yield step.prompt("QUESTION_PROMPT", 'Ask the question');
        });
        this.displayHelpResults = (step) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.addDialog(new botbuilder_dialogs_1.WaterfallDialog("HELP_DIALOG_ID", [
